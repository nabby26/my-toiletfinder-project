# -*- encoding: utf-8 -*-
# stub: google-gax 0.8.7 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<googleapis-common-protos>.freeze, ["~> 1.3.5"])
      ...
      s.add_dependency(%q<googleapis-common-protos>.freeze, ["~> 1.3.5"])
